# Emacs mode
bindkey -M emacs '^K'      up-history # ^K to previous command.
bindkey -M emacs '^J'      down-history # ^J to next command.

# Insert Mode
bindkey -M viins '^K' up-history # ^K to previous command.
bindkey -M viins '^J' down-history # ^J to next command.
bindkey -M viins '^F' vi-forward-word # Go forward char or complete current completion.
...
bindkey -M viins '^E' custom-jump-after-first-word # Jump behind the first word on the command
