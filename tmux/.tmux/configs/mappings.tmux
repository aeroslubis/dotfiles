...
bind-key -n M-Tab last-window       # Switch between previous window
...
# Copy
# bind-key -T copy-mode-vi y send-keys -X copy-pipe-and-cancel "xclip -i -f -selection primary | xclip -i -selection clipboard" # Copy to system clipboard.
bind-key -T copy-mode-vi y send-keys -X copy-pipe-and-cancel "xclip -in -selection clipboard" # Copy to system clipboard.
